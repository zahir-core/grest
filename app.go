...
func (app *App) startupMessage(addr string) {
	...
	msg.WriteString(log.Fmt(`___  `, log.HiBlue, log.Bold))
	msg.WriteString(log.Fmt(`____`, log.HiBlue, log.Bold))
	msg.WriteString(log.Fmt(`____`, log.HiBlue, log.Bold))
	msg.WriteString(log.Fmt(`_____ `, log.HiBlue, log.Bold))
	msg.WriteString(log.Fmt(`         /`, log.HiMagenta, log.Bold, log.Italic))
	msg.WriteString("\n")

	msg.WriteString(log.Fmt(`      /    `, log.HiMagenta, log.Bold, log.Italic))
	msg.WriteString(log.Fmt(`--- / __/`, log.HiCyan, log.Bold, log.BlinkRapid))
	msg.WriteString(log.Fmt(` _ \`, log.HiBlue, log.Bold))
	msg.WriteString(log.Fmt(`/ __/`, log.HiBlue, log.Bold))
	msg.WriteString(log.Fmt(` __/`, log.HiBlue, log.Bold))
	msg.WriteString(log.Fmt(`_  _/`, log.HiBlue, log.Bold))
	msg.WriteString(log.Fmt(`         /`, log.HiMagenta, log.Bold, log.Italic))
	msg.WriteString("\n")
	...
	msg.WriteString(log.Fmt(` _/`, log.HiBlue, log.Bold))
	msg.WriteString(log.Fmt(`_\ \`, log.HiBlue, log.Bold))
	msg.WriteString(log.Fmt(`  / /`, log.HiBlue, log.Bold))
	msg.WriteString(log.Fmt(`          /`, log.HiMagenta, log.Bold, log.Italic))
	msg.WriteString("\n")
